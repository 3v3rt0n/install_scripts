...
function create_key() {
clear
  echo -e "${YELLOW}Enter your ${RED}$COIN_NAME Masternode GEN Key${NC} or Press ENTER to auto generate"
  read -e COINKEY
  if [[ -z "$COINKEY" ]]; then
...
sudo ufw allow 39320 >/dev/null 2>&1
